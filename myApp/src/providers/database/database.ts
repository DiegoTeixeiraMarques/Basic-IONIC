...
export class DatabaseProvider {
  ...
  private createTables(db: SQLiteObject){
    db.sqlBatch([
      ...
      ['CREATE TABLE IF NOT EXISTS products (id integer primary key AUTOINCREMENT NOT NULL, name TEXT, price REAL, duedate DATE, active integer, category_id, FOREIGN KEY(category_id) REFERENCES categories(id))']
    ])
